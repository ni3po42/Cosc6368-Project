...
# STRATTON NOTE: to get partial fit working, had to add some two checks for the linear_binarizer?
#this file is simply to document where I added my changes if I need to do this again: Lines 273, and 943!
...
class BaseMultilayerPerceptron(BaseEstimator, metaclass=ABCMeta):
    ...
    def _initialize(self, y, layer_units):
        ...
        elif hasattr(self, '_label_binarizer') and self._label_binarizer.y_type_ == 'multiclass':
        ...
        if not incremental:
            ...
            if len(np.setdiff1d(classes, self.classes_, assume_unique=True)):
                raise ValueError("`y` has classes not in `self.classes_`."
                                 ...
                                 (self.classes_, classes))
        if hasattr(self, '_label_binarizer'):
